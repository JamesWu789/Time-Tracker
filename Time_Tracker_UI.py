...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.add_new_event.setGeometry(QtCore.QRect(50, 110, 93, 28))
        self.add_new_event.setObjectName("add_new_event")
        self.input_event = QtWidgets.QLineEdit(self.centralwidget)
        self.input_event.setGeometry(QtCore.QRect(50, 40, 121, 41))
        ...
        self.edit_event.setGeometry(QtCore.QRect(50, 150, 93, 28))
        ...
        self.listWidget.setGeometry(QtCore.QRect(180, 40, 256, 192))
        ...
        self.show_date.setGeometry(QtCore.QRect(550, 270, 141, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.show_date.setText(_translate("MainWindow", "顯示當日結果"))
        self.lineEdit.setText(_translate("MainWindow", "工作名稱"))
        self.lineEdit_2.setText(_translate("MainWindow", "時間 (     分     :     秒        )"))
        self.lineEdit_4.setText(_translate("MainWindow", "事件列表"))
        self.remove_event.setText(_translate("MainWindow", "刪除事件"))
